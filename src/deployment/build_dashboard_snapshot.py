...
DASHBOARD_TABLES = (
    ...
    SnapshotTable("analytics", "game_prediction_archive", required=False),
    SnapshotTable("analytics", "completed_game_prediction_results", required=False),
    SnapshotTable("analytics", "selected_signal_archive", required=False),
    SnapshotTable("analytics", "selected_signal_settlement", required=False),
    SnapshotTable("analytics", "selected_signal_performance_summary", required=False),
