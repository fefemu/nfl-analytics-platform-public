...
Spread Model Expanding-Window Backtest

Purpose:
    Compare spread feature sets and Ridge alpha values
...
def evaluate_spread_expanding_window(
    ...
    """Run chronological spread candidate backtests."""
...
def run_spread_expanding_window_backtest(
    database_file: Path = DATABASE_FILE,
) -> tuple[pd.DataFrame, pd.DataFrame]:
    """Load DuckDB data and run the spread backtest."""
    ...
    logger.info(
        "Spread expanding-window backtest completed "
...
def main() -> None:
    """Run and print the spread backtest."""

    summary_results, fold_results = (
        run_spread_expanding_window_backtest()
    )
