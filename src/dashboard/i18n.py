...
COPY: dict[str, dict[Language, str]] = {
    ...
    "subtitle_performance": {
        "EN": "Forward performance of locked pre-game predictions and published betting selections.",
        "HU": "A meccsek előtt rögzített predikciók és publikált fogadási jelzések forward teljesítménye.",
    },
