...
COPY: dict[str, dict[Language, str]] = {
    ...
    "subtitle_performance": {"EN": "Verified pre-game model evaluation and published betting results.", "HU": "Hiteles meccs előtti modellértékelés és publikált fogadási eredmények."},
