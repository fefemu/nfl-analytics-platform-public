...
COPY: dict[str, dict[Language, str]] = {
    ...
    "nav_performance": {"EN": "Results", "HU": "Eredmények"},
    ...
    "subtitle_performance": {
        "EN": "Forward performance of locked pre-game predictions and Recommended Picks published on the Betting Board.",
        "HU": "A meccsek előtt rögzített predikciók és a Betting Boardon publikált Javasolt tippek forward teljesítménye.",
    },
    ...
    "top_candidates": {"EN": "Featured Picks", "HU": "Kiemelt tippek"},
