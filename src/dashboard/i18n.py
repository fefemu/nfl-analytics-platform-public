...
COPY: dict[str, dict[Language, str]] = {
    ...
    "subtitle": {"EN": "Production models, market intelligence and season simulations in one workspace.", "HU": "Production modellek, market elemzés és szezon-szimulációk egy helyen."},
    "subtitle_overview": {"EN": "Current-week matchups, expected scores and win probabilities.", "HU": "Az aktuális hét mérkőzései, várható eredményei és győzelmi valószínűségei."},
    ...
    "model_suite": {"EN": "Model suite", "HU": "Model suite"},
    "markets_3": {"EN": "3 markets", "HU": "3 market típus"},
    "simulation": {"EN": "Simulation", "HU": "Monte Carlo"},
    "runs_10000": {"EN": "10,000 runs", "HU": "10 000 futás"},
    "last_refresh": {"EN": "Last successful refresh", "HU": "Utolsó sikeres refresh"},
    "not_available": {"EN": "Not available", "HU": "Nem elérhető"},
    "data_ready": {"EN": "DATA READY", "HU": "ADATOK ELÉRHETŐK"},
    "refresh_required": {"EN": "REFRESH REQUIRED", "HU": "REFRESH SZÜKSÉGES"},
    ...
    "minimum_model_probability": {"EN": "Minimum model probability %", "HU": "Minimum modellvalószínűség %"},
    "minimum_books": {"EN": "Minimum books", "HU": "Minimum bookmaker-szám"},
    "positive_ev_only": {"EN": "Positive EV only", "HU": "Csak pozitív EV"},
    "top_candidates": {"EN": "Top picks", "HU": "Top tippek"},
    "market_detail": {"EN": "Market detail", "HU": "Részletes market-adatok"},
    "teams": {"EN": "Teams", "HU": "Csapatok"},
    "simulations": {"EN": "Simulations", "HU": "Simulation futások"},
    ...
    "all_team_outlook": {"EN": "All-team outlook", "HU": "Teljes liga outlook"},
    "team_distribution": {"EN": "Team distribution", "HU": "Csapat win distribution"},
    "team": {"EN": "Team", "HU": "Csapat"},
    "dynamic_frozen": {"EN": "Dynamic vs frozen Elo", "HU": "Dinamikus és rögzített Elo összehasonlítása"},
    "lab_intro": {"EN": "Curated evidence behind the production models.", "HU": "A production modellek mögötti, válogatott bizonyítékok."},
    "production_model": {"EN": "Production model", "HU": "Production model"},
